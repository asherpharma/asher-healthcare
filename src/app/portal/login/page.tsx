...
export default function PatientPortalLoginPage() {
  ...
  const activatePortal = useCallback(async (user: User) => {
    ...
    if (!response.ok) throw new Error(result.error || "This portal invitation is not active.");
  }, []);
