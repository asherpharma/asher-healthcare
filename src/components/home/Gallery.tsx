    ...
    <section id="clinic" className="section gallery-section">
      <div className="site-shell">
        ...
        <div className="gallery-grid">
          <figure className="gallery-item gallery-main"><Image src="/asher-hero-clinic-v2.webp" alt="Representative concept of a calm modern family clinic" fill sizes="(max-width: 900px) 92vw, 58vw" /><figcaption><span><Camera /> Representative clinic concept</span><strong>Calm spaces. Considered care.</strong></figcaption></figure>
          <figure className="gallery-item gallery-art"><Image src="/asher-abstract-care-v2.webp" alt="Abstract navy and gold women and child care artwork" fill sizes="(max-width: 900px) 92vw, 35vw" /><figcaption><span><Sparkles /> Our care philosophy</span><strong>Women and children at the centre.</strong></figcaption></figure>
