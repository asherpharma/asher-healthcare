      ...
      <div className="site-shell">
        ...
        <div className="contact-grid">
          ...
          <div className="contact-cards">
            ...
            <article><span><Clock3 /></span><div><small>Specialist appointments · Monday–Saturday</small><p><strong>Dr. Shafi: 5:00 PM–8:00 PM</strong><br /><strong>Dr. Reshma: 7:00 PM–9:00 PM</strong></p></div></article>
