...
const reasons = [
  ...
  { icon: Clock3, title: "Simple access", text: "Open daily with quick calling, WhatsApp booking and one-tap directions." },
];
    ...
    <section className="section why-section">
      <div className="site-shell why-grid">
        <div className="why-visual">
          <div className="abstract-card"><Image src="/asher-abstract-care.png" alt="A modern illustration celebrating women and child healthcare" fill sizes="(max-width: 900px) 92vw, 44vw" /></div>
